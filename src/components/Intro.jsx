...
=======
      navigate('/frames?scrollTo=13'); // Use query parameter to indicate the product ID
    } else if (serviceName === "Photo Frames") {
      navigate('/frames?scrollTo=1'); // Use query parameter to indicate the product ID
    } else if (serviceName === "Bracelets") {
      navigate('/frames?scrollTo=25'); // Use query parameter to indicate the product ID
>>>>>>> 32c962d494cf8cd29227d09cbf5b1af7c2dbd723
    }
  };
